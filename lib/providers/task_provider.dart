...
class TaskProvider extends ChangeNotifier {
  ...
  Future<void> loadTasks() async {
    ...
    try {
      ...
      _tasks = taskMaps.map((t) => Task.fromJson(Map<String, dynamic>.from(t))).toList();
      _applyFilters();
  ...
  Future<Task?> updateTask(String taskId, Map<String, dynamic> taskData) async {
    ...
    try {
      ...
      final updatedTask = Task.fromJson(Map<String, dynamic>.from(taskMap));
  ...
  Future<Task?> getTask(String taskId) async {
    try {
      ...
      return Task.fromJson(Map<String, dynamic>.from(taskMap));
    } catch (e) {
